...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://meant2yu.api.sanity.io/v2023-08-01/graphql/production/default/", {
    method: "POST",
...
export type CourseSorting = {
  ...
  _updatedAt?: InputMaybe<SortOrder>;
  description?: InputMaybe<SortOrder>;
  thumbnail?: InputMaybe<ImageSorting>;
  title?: InputMaybe<SortOrder>;
};
...
export type RootQueryAllChapterArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  sort?: InputMaybe<Array<ChapterSorting>>;
